<template>
   <header class="header">
      <div class="header_left">
         ...
         <svg class="logo" xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt6" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true" style="pointer-events: none; display: inherit; width: 100%; height: 100%;">
   <g>
   ...
   <g id="youtube-paths_yt6">
      ...
      <div class="nav_mid">
         <input placeholder="Введите запрос" type="text" class="input_search">
      ...
      <div class="nav_links">
        ...
        <nuxt-link to="shorts">Shorts</nuxt-link>
